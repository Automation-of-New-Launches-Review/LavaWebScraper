...
###############################################################
path_of_brandwise = 'C:\\LavaWebScraper\\GSMARENA\\'
###############################################################
...
df.to_csv(os.path.join(path_of_brandwise, 'gsmAlcatel-'+str(datetime.date.today()) +'.csv'), index=False, encoding='utf-8')
